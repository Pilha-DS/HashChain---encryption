...
def encrypter(
    ...
    def create_salt(ciphertext_list: list, current_pass: list, current_seed: int) -> tuple:
        ...
        for _ in range(salt_leng):
            ...
            # Gera seed única para o salt
            seed_salt = current_seed + salt_pass + posicao
            ...
            if debug_mode:
                ...
                posicoes.append(str(len(str(posicao))))
                posicoes.append(str(posicao))
        
        return salt_ciphertext_list, salt_passes, posicoes

    def key_generator(passes_list: list, current_seed: int, seeds_passes: list = None, salt_positions: list = None, padding: str = '') -> tuple:
        ...
        poli_seeds = [str(s).zfill(20) for s in seeds_passes] if seeds_passes else []
